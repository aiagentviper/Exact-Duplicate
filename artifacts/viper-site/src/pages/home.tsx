...
export function HomePage() {
  return (
    <div className="bg-background min-h-screen text-foreground dark">
      <Navigation />
      <main>
        {/* Hero with 30px top + bottom breathing room */}
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              >
                ...
                <p className="font-inter text-[15px] text-muted-foreground mt-4 max-w-xs leading-relaxed">
                  Three clear steps from first conversation to finished product — no complexity, no confusion.
                </p>
              </motion.div>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              >
                ...
                <p className="font-inter text-[15px] text-muted-foreground mt-4 max-w-xs leading-relaxed">
                  Curious what sets us apart from every other agency out there? Here's the honest answer.
                </p>
                <Link href="/about">
              ...
              <div className="grid gap-4">
                {answers.map((item, i) => (
                  <motion.div
                    ...
                    className="group flex items-start gap-5 rounded-2xl border border-border/40 bg-card p-6 hover:border-border/70 transition-colors"
                  >
